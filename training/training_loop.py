...
def training_schedule(
    ...
    lod_training_kimg       = 100,      # Thousands of real images to show before doubling the resolution.
    lod_transition_kimg     = 100,      # Thousands of real images to show when fading in new layers.
    minibatch_base          = 8,       # Maximum minibatch size, divided evenly among GPUs.
    ...
    tick_kimg_base          = 100,      # Default interval of progress snapshots.
...
def training_loop(
    ...
    resume_run_id           = 4,     # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = None,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 520,      # Assumed training progress at the beginning. Affects reporting and training schedule.
